...
func runMigrations(db *sql.DB) error {
	...
	CREATE INDEX IF NOT EXISTS idx_knowledge_graph_source ON knowledge_graph(source_doc_id);
	CREATE INDEX IF NOT EXISTS idx_knowledge_graph_target ON knowledge_graph(target_doc_id);
